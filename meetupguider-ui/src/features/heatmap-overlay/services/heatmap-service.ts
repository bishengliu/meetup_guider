...
function convertContryCode(country: string) {
  ...
  return countryCodes[country.toUpperCase()];
}

function toBubbleData(rsvpCity: RSVPCity) {
  return {
    name: rsvpCity.city,
    country: convertContryCode(rsvpCity.country),
    count: rsvpCity.cityCount,
    radius: rsvpCity.cityCount,
...
function toMapData(rsvpCities : RSVPCity[]) {
